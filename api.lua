...
local bot = '388379367:AAGf35UtFkYPagIbnE3fZPa9vWL2y7HtHOg'
...
{text="به کانال ما بپیوندید",url="https://telegram.me/joinchat/AAAAAD7Im8eGLNUtjUlJxg"}
 ...
 if msg.content_.ID == "MessageChatAddMembers" and msg.content_.id_ == 180122599 then
...
{text="به کانال ما بپیوندید",url="https://telegram.me/akhkamaram"}

}
}
}
 sendinline(msg.chat_id_,'امار ربات پیشرفته تبچی',keyboard)
end
